...
class RatingCalculatorTest {
    ...
    private fun rule(
        ...
        unitPrice = UnitPrice(BigDecimal(unitPrice)),
    ...
    private fun lookupOf(vararg rules: PricingRule) = object : PricingRuleLookup {
        ...
        override fun findAllFor(tenant: TenantId) = rules.toList()

        override fun findById(tenant: TenantId, id: Long) = rules.firstOrNull { it.id == id }
    }
